...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           LT(13, KC_V),   KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RIGHT_SHIFT, 
                                                    LT(6, KC_ENTER),MO(2),                                          LT(3, KC_BSPC), KC_SPACE
  ),
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, MT(MOD_LCTL, KC_N),MT(MOD_LALT, KC_S),MT(MOD_LGUI, KC_H),MT(MOD_LSFT, KC_T),LT(4, KC_M),                                    KC_Y,           MT(MOD_RSFT, KC_C),MT(MOD_RGUI, KC_A),MT(MOD_RALT, KC_E),MT(MOD_RCTL, KC_I),LT(8, KC_MINUS),
    KC_UNDS,        MT(MOD_LCTL, KC_X),KC_V,           KC_J,           KC_K,           KC_Z,                                           KC_QUOTE,       KC_W,           KC_SLASH,       KC_SCLN,        KC_COMMA,       KC_TRANSPARENT, 
                                                    KC_R,           LT(2, KC_ENTER),                                MO(3),          KC_SPACE
  ),
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    LALT(KC_N),     LALT(KC_P),     LALT(KC_6),     LALT(KC_5),     LALT(KC_4),     KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_4,           KC_5,           KC_6,           KC_TRANSPARENT, KC_TRANSPARENT, 
    LALT(KC_U),     LALT(KC_A),     LALT(KC_3),     LALT(KC_2),     LALT(KC_1),     LALT(KC_B),                                     KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_0,           CW_TOGG,        
    KC_TRANSPARENT, LALT(KC_O),     LALT(KC_9),     LALT(KC_8),     LALT(KC_7),     LALT(KC_I),                                     KC_TRANSPARENT, KC_7,           KC_8,           KC_9,           KC_SPACE,       KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, LCTL(KC_B)
  ),
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, RGB_VAD,        RGB_VAI,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_AUDIO_MUTE,  KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_TRANSPARENT, 
    KC_TRANSPARENT, LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),   KC_MS_UP,       KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_HOME,        KC_TRANSPARENT, LGUI(LSFT(KC_SPACE)),KC_END,         KC_TRANSPARENT, KC_DELETE,      
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),   KC_UNDS,        LGUI(KC_R),     LGUI(LSFT(KC_C)),                                KC_TRANSPARENT, KC_LCBR,        KC_RCBR,        KC_DLR,         ST_MACRO_14,    KC_TRANSPARENT, 
    KC_TILD,        KC_EXLM,        KC_PLUS,        KC_AMPR,        KC_EQUAL,       KC_GRAVE,                                       KC_AT,          KC_LPRN,        KC_RPRN,        KC_CIRC,        KC_PERC,        ST_MACRO_15,    
    KC_TRANSPARENT, KC_PIPE,        KC_ASTR,        LGUI(KC_C),     LGUI(KC_V),     KC_BSLS,                                        KC_TRANSPARENT, KC_LBRC,        KC_RBRC,        KC_HASH,        KC_TRANSPARENT, ST_MACRO_16,    
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_LCBR,        KC_RCBR,        KC_DLR,         KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_AT,          KC_LPRN,        KC_RPRN,        KC_CIRC,        KC_PERC,        ST_MACRO_17,    
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_LBRC,        KC_RBRC,        KC_HASH,        KC_TRANSPARENT, ST_MACRO_18,    
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [8] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TILD,        KC_EXLM,        KC_PLUS,        KC_AMPR,        KC_EQUAL,       ST_MACRO_19,                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [13] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, LALT(KC_4),     LALT(KC_5),     LALT(KC_6),     LALT(KC_P),     LALT(KC_N),     
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 LALT(KC_B),     LALT(KC_1),     LALT(KC_2),     LALT(KC_3),     LALT(KC_A),     LALT(KC_U),     
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 LALT(KC_I),     LALT(KC_7),     LALT(KC_8),     LALT(KC_9),     LALT(KC_O),     KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
...
const uint16_t PROGMEM combo1[] = { MT(MOD_LSFT, KC_F), KC_W, COMBO_END};
const uint16_t PROGMEM combo2[] = { KC_9, KC_7, COMBO_END};
const uint16_t PROGMEM combo3[] = { KC_Q, KC_W, COMBO_END};
const uint16_t PROGMEM combo4[] = { KC_COMMA, KC_DOT, COMBO_END};
const uint16_t PROGMEM combo5[] = { MT(MOD_RALT, KC_L), MT(MOD_RSFT, KC_J), COMBO_END};
const uint16_t PROGMEM combo6[] = { MT(MOD_RSFT, KC_J), MT(MOD_RALT, KC_L), MT(MOD_LGUI, KC_K), COMBO_END};
const uint16_t PROGMEM combo7[] = { MT(MOD_RSFT, KC_J), MT(MOD_LGUI, KC_K), COMBO_END};
const uint16_t PROGMEM combo8[] = { MT(MOD_LGUI, KC_D), MT(MOD_LSFT, KC_F), COMBO_END};
const uint16_t PROGMEM combo9[] = { MT(MOD_LALT, KC_S), MT(MOD_LGUI, KC_D), COMBO_END};
const uint16_t PROGMEM combo10[] = { MT(MOD_LGUI, KC_K), MT(MOD_RALT, KC_L), COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
    COMBO(combo0, ST_MACRO_20),
    COMBO(combo1, KC_UNDS),
    COMBO(combo2, KC_AUDIO_MUTE),
    COMBO(combo3, KC_BSPC),
    COMBO(combo4, RALT(KC_BSPC)),
    COMBO(combo5, CW_TOGG),
    COMBO(combo6, KC_CAPS),
    COMBO(combo7, OSM(MOD_RSFT)),
    COMBO(combo8, OSM(MOD_LSFT)),
    COMBO(combo9, OSL(7)),
    COMBO(combo10, OSL(8)),
};
