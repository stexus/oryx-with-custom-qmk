...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    LT(7, KC_TAB),  KC_Q,           MT(MOD_LALT, KC_W),KC_E,           KC_R,           KC_T,                                           KC_Y,           KC_U,           KC_I,           MT(MOD_RALT, KC_O),KC_P,           LT(8, KC_BSPC), 
    ...
    CW_TOGG,        MT(MOD_LCTL, KC_Z),KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_EQUAL,       
...
const uint16_t PROGMEM combo4[] = { KC_Q, KC_1, COMBO_END};
const uint16_t PROGMEM combo5[] = { KC_P, KC_0, COMBO_END};
