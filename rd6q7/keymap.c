...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           LT(13, KC_V),   KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RIGHT_SHIFT, 
                                                    LT(6, KC_ENTER),KC_LEFT_GUI,                                    LT(3, KC_BSPC), KC_SPACE
  ),
  [1] = LAYOUT_voyager(
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_GRAVE,       LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),   KC_RABK,        KC_MINUS,       ST_MACRO_14,                                    KC_TRANSPARENT, KC_LCBR,        KC_RCBR,        KC_DLR,         KC_HASH,        KC_TRANSPARENT, 
    KC_TILD,        KC_EXLM,        KC_PLUS,        KC_AMPR,        KC_EQUAL,       KC_PERC,                                        KC_AT,          KC_LPRN,        KC_RPRN,        KC_CIRC,        KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_PIPE,        KC_ASTR,        KC_LABK,        KC_UNDS,        KC_BSLS,                                        KC_GRAVE,       KC_LBRC,        KC_RBRC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
